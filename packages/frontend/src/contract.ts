...
export const contractAddress = "0xc266ab1954d4d237c78f43176ac47a0f4c3de259";
export const abi: Abi | undefined = [
  ...
  },
  {
    type: "function",
    name: "getGroups",
    inputs: [{ name: "groupIds", type: "int256[]", internalType: "int256[]" }],
    outputs: [
      {
        name: "",
        type: "tuple[]",
        internalType: "struct ZiniSavings.GroupInfo[]",
        components: [
          {
