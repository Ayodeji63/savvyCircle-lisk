...
const Notification = ({
  ...
  return toast.custom(
    (t) => (
      <div
        className={`shadow-center relative flex max-w-sm transform-gpu flex-row items-start justify-between space-x-2 rounded-xl bg-white p-4 shadow-accent transition-all duration-500 ease-in-out ${
      ...
      >
        ...
        <div
          className={`overflow-x-hidden whitespace-pre-line break-words ${icon ? "mt-1" : ""}`}
        >
          {content}
        </div>
