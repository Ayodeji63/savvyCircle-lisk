    ...
    return (
        <div className="">
            ...
            <div className="space-y-4">
                {sortedTransactions ? sortedTransactions?.map((transaction) => <div key={transaction.transactionHash} className="flex items-center justify-between rounded-[8px] border border-[#D7D9E4] bg-white px-4 py-5 shadow-[0px_4px_8px_0px_#0000000D]" >
                ...
                </div>) : <p>No recent transactions</p>}
            </div>
        </div>
    );
};
